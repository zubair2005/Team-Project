...
def build_dashboard(root: tk.Misc, user: Dict[str, str], logout_callback: Callable[[], None]) -> tk.Frame:
    ...
    def validate_dates(start: str, end: str) -> bool:
        ...
        # changed to \d{2} because that's what it is everywhere else
        ...
        try:
            ...
            start_dt = datetime.date(start_parts[0], start_parts[1], start_parts[2])
            end_dt = datetime.date(end_parts[0], end_parts[1], end_parts[2])
